...
import com.example.currencyconsverterprep.data.models.Rates
...
class MainViewModel @ViewModelInject constructor(
    ...
    fun convert(
        ...
        if (fromAmount == null) {
            _conversion.value = CurrencyEvent.Failure("유효하지 않습니다")
        }
        ...
        viewModelScope.launch(dispatchers.io) {
            ...
            when (val ratesResponse = repository.getRates(fromCurrency)) {
                ...
                is Resource.Success -> {
                    ...
                    if (rate == null) {
                        _conversion.value = CurrencyEvent.Failure("에러")
                    } else {
                        if (fromAmount != null) {
                            ...
                            _conversion.value = CurrencyEvent.Failure("값을 적어주세요")
                        }
                    }
                }
            }
